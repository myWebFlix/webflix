...
public class InfoResource {
	...
	public Response getInfo() {
		String message = "{" +
				...
				"\"mikrostoritve\": [\"http://34.89.197.212:8080/v1/videos\", \"http://34.107.92.162:8080/v1/streams\"]," +
				"\"github\": [\"https://github.com/myWebFlix/webflix\", \"https://github.com/myWebFlix/video-stream\", \"https://github.com/myWebFlix/users\"]," +
				"\"travis\": []," +
				"\"dockerhub\": [\"https://hub.docker.com/r/webflix/webflix\", \"https://hub.docker.com/r/webflix/video-stream\"]" +
				"}";
